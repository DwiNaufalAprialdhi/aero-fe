                        ...
                        <section className='lg:col-span-6 col-span-12 flex flex-col'>
                              ...
                              <div className='w-full grid lg:grid-cols-2 grid-cols-1 lg:gap-[50px] gap-6'>
                                    ...
                                    <div className='w-full h-max flex flex-col gap-6'>
                                          ...
                                          <div className='w-full flex items-center gap-x-[8px]'>
                                                <svg className='lg:w-6 w-4 lg:h-6 h-4' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                      <path d="M12 13C13.6569 13 15 11.6569 15 10C15 8.34315 13.6569 7 12 7C10.3431 7 9 8.34315 9 10C9 11.6569 10.3431 13 12 13Z" stroke="#352B5A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        ...
                        <section className='lg:col-span-6 col-span-12 flex lg:flex-row flex-col items-start lg:gap-[100px] gap-[50px]'>
                              <form action={'#'} className='w-full flex flex-col'>
                                    ...
                                    <div className='w-full flex flex-col gap-y-[8px] mb-6'>
                                          <label htmlFor="email" className='label_light'>Email</label>
