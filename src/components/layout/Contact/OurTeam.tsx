...
export default function OurTeam() {
      ...
      return (
            <>
                  <main className="w-full h-auto overflow-hidden relative lg:pt-[200px] pt-[110px] lg:mb-[150px] mb-[50px]">
                        {/* Ornament */}
                        <div className="w-full h-auto absolute -top-[100px] left-0 z-[1]">
                              <Image
                        ...
                        <section className='container_section grid grid-cols-10 items-center lg:gap-[50px] gap-6 relative z-[2]'>
                              {/* Left */}
                              <div data-aos='fade-right' className='w-full lg:col-span-5 col-span-10 flex flex-col'>
                                    <h2 className="w-full md:max-w-[1010px] max-w-none font-bold lg:text-[60px] text-[36px] lg:leading-[80px] leading-[38px] text-start text-theme-brand">
                                          Contact <span className='text-theme-red'>Our Team</span>
                                    </h2>
                                    <p className='w-full md:max-w-[1010px] max-w-none font-normal lg:text-base text-sm leading-normal text-slate-400 text-start lg:mt-[14px] mt-[24px] lg:mb-[50px] mb-6'>
                                    ...
                                    <div className='w-full grid lg:grid-cols-2 grid-cols-1 lg:gap-[50px] gap-6'>
                                          <div className='w-full col-span-1 flex flex-col'>
                                                <div className='w-full flex flex-col mb-[24px]'>
                                                      <h2 className='font-semibold lg:text-[24px] text-sm text-theme-brand'>Chat with us</h2>
                                                ...
                                                <div className='flex flex-col gap-y-[14px]'>
                                                      <div className='w-full flex items-center gap-x-[8px]'>
                                                            ...
                                                            <h2 className='font-semibold lg:text-base text-sm text-theme-brand underline'>Shoot us an email</h2>
                                                      </div>
                                                      <div className='w-full flex items-center gap-x-[8px]'>
                                                            <svg className='lg:w-6 w-4 lg:h-6 h-4' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <h2 className='font-semibold lg:text-base text-sm text-theme-brand underline'>Message us on Instagram</h2>
                                                      </div>
                                                </div>
                                          </div>
                                          <div className='w-full col-span-1 flex flex-col'>
                                                <div className='w-full flex flex-col mb-[24px]'>
                                                      <h2 className='font-semibold lg:text-[24px] text-sm text-theme-brand'>Call us</h2>
                                                ...
                                                <div className='w-full flex items-center gap-x-[8px]'>
                                                      ...
                                                      <h2 className='font-semibold lg:text-base text-sm text-theme-brand underline'>+62 21 84596900</h2>
                                                </div>
                                          </div>
                                          <div className='w-full col-span-1 flex flex-col'>
                                                <div className='w-full flex flex-col mb-[24px]'>
                                                      <h2 className='font-semibold lg:text-[24px] text-sm text-theme-brand'>Visit us</h2>
                                                ...
                                                <div className='w-full flex items-center gap-x-[8px]'>
                                                      ...
                                                      <h2 className='font-semibold lg:text-base text-sm text-theme-brand underline'>Wiladatika Private Airport</h2>
                                                </div>
                                          </div>
                                    </div>
                              </div>
                              {/* Right */}
                              <div data-aos='fade-left' className='w-full lg:col-span-5 col-span-10 bg-slate-100 p-5 lg:rounded-[16px] rounded-[8px]'>
                                    <form action={'#'} className='w-full flex flex-col'>
                                          ...
                                          <Button link={'https://maps.app.goo.gl/tcqNN8RMvFbPK8uB8'} className='flex items-center justify-center w-full'>
                                                Send message
                                          </Button>
                                    </form>
                              </div>
                        </section>
                        <section className='w-full overflow-hidden lg:mt-[150px] mt-[50px] flex lg:justify-end justify-normal relative z-[2]'>
                              <div className='w-full container_section grid grid-cols-10 items-center relative lg:gap-[20px] gap-[20px]'>
                                    <div className='w-full lg:h-[518px] md:h-[400px] h-[214px] lg:rounded-[16px] rounded-[10px] overflow-hidden lg:col-span-4 col-span-10 relative'>
                                    ...
                                    <div className='w-full lg:max-w-none md:max-w-[696px] max-w-none lg:mx-0 mx-auto lg:col-span-6 col-span-10 lg:items-start lg:justify-start items-center justify-center flex flex-col p-5 lg:text-start text-center'>
                                          ...
                                          <h2 className='font-bold lg:text-[48px] text-[36px] lg:leading-[48px] leading-[38px] text-theme-donker mt-[14px] lg:mb-[50px] mb-6'>
