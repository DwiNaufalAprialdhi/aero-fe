      ...
      return (
            <>
                  <main className="w-full h-auto overflow-hidden relative lg:pt-[200px] pt-[110px] lg:mb-[150px] mb-[50px]">
                        <section className='container_section grid grid-cols-10 items-center lg:gap-[50px] gap-6'>
                              {/* Left */}
                              <div data-aos='fade-right' className='w-full lg:col-span-5 col-span-10 flex flex-col'>
                                    <h2 className="w-full md:max-w-[1010px] max-w-none font-bold lg:text-[60px] text-[36px] lg:leading-[80px] leading-normal text-start text-theme-brand">
