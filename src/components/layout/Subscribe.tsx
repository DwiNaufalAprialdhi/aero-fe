                  ...
                  <section className='container_section absolute top-[-120px] inset-x-0 z-[5]'>
                        <div className='w-full bg-[#F8FAFC] p-[30px] flex flex-col relative'>
                              ...
                              <div className='py-[20px] flex flex-col gap-y-[14px] mb-[14px] relative z-[3]'>
                                    <h2 className='font-semibold text-[24px] text-center lg:text-start'>
                                          {lang === 'ID' ? 'Bergabunglah dengan buletin mingguan kami' : 'Join our weekly newsletter'}
                                    </h2>
                                    <p className='font-normal text-base text-theme-secondary text-center lg:text-start'>
                                          {lang === 'ID' ? 'Tetap ikuti berita, pengumuman, dan artikel terkini.' : 'Stay up to date with the lastest news, announcements, and articles.'}
                                    </p>
                              </div>
                              <div className='w-full max-w-[367px] relative z-[3]'>
                                    ...
                                    <Link href={''} className={`absolute top-1/2 -translate-y-1/2 right-[3px] py-2 lg:px-[30px] px-[15px] bg-theme-brand text-white rounded-[8px] hover:bg-opacity-80 duration-300`}>
                                          <h2 className='font-medium lg:text-sm text-xs'>
                                                {lang === 'ID' ? 'Berlangganan' : 'Subscribe'}
                                          </h2>
                                    </Link>
                              </div>
