      ...
      return (
            <>
                  <main className='w-full overflow-hidden lg:mb-[150px] mb-[100px]'>
                        ...
                        <section className='container_section flex lg:flex-row flex-col items-start lg:gap-[100px] gap-[50px]'>
                              ...
                              <div className='lg:w-[30%] w-[100%] flex flex-col'>
                                    <div className='w-full flex flex-col mb-[24px]'>
                                          <h2 className='font-semibold lg:text-[24px] text-base text-theme-brand'>Chat with us</h2>
                                    ...
                                    <div className='w-full flex flex-col mb-[24px]'>
                                          <h2 className='font-semibold lg:text-[24px] text-base text-theme-brand'>Call us</h2>
                                    ...
                                    <div className='w-full flex flex-col mb-[24px]'>
                                          <h2 className='font-semibold lg:text-[24px] text-base text-theme-brand'>Visit us</h2>
