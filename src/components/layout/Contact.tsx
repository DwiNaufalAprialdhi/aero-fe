            ...
            <>
                  <main className='container_section  w-full overflow-hidden relative z-[2] grid grid-cols-12 lg:gap-[50px] gap-6'>
                        <section className='lg:col-span-6 col-span-12 flex flex-col text-slate-50'>
                              <LabelSectionLight title={lang === 'ID' ? 'Hubungi kami' : 'Contact Us'} />
                              <h2 className='font-bold lg:text-[48px] text-[24px] leading-tight my-[14px]'>
                                    {lang === 'ID' ? 'Hubungi ' : 'Contact Our '}
                                    <span className='font-bold text-theme-red'>
                                          {lang === 'ID' ? 'Tim Kami' : 'Team'}
                                    </span>
                              </h2>

                              <p className='font-normal lg:text-base text-sm text-theme-secondary mb-[50px]'>
                                    {lang === 'ID'
                                          ? '"Kami berkomitmen untuk mengembangkan bandara penerbangan umum di Indonesia."'
                                          : '"We are committed to developing general aviation airports in Indonesia."'}
                              </p>
                              <div className='w-full grid lg:grid-cols-2 grid-cols-1 lg:gap-[50px] gap-6'>
                                    <div className='w-full h-max flex flex-col gap-6'>
                                          <div className='w-full flex flex-col gap-1'>
                                                <h2 className='font-semibold lg:text-[24px] text-base text-slate-50'>
                                                      {lang === 'ID' ? 'Ngobrol dengan kami' : 'Chat with us'}
                                                </h2>
                                    ...
                                    <div className='w-full h-max flex flex-col gap-6'>
                                          <div className='w-full flex flex-col gap-1'>
                                                ...
                                                <p className='font-normal lg:text-base text-sm text-theme-secondary'>
                                                      {lang === 'ID'
                                                            ? 'Hubungi tim kami pada Senin–Jumat pukul 08.00 hingga 17.00.'
                                    ...
                                    <div className='w-full h-max flex flex-col gap-6'>
                                          <div className='w-full flex flex-col gap-1'>
                                                ...
                                                <p className='font-normal lg:text-base text-sm text-theme-secondary'>
                                                      {lang === 'ID'
                                                            ? 'Temui kami langsung di kantor kami.'
                                                            : 'Chat to us in person at our office.'}
                                                </p>
                                          </div>
                                          <div className='w-full flex items-center gap-x-[8px]'>
                                                <svg className='lg:w-6 w-4 lg:h-6 h-4' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                      <path d="M12 13C13.6569 13 15 11.6569 15 10C15 8.34315 13.6569 7 12 7C10.3431 7 9 8.34315 9 10C9 11.6569 10.3431 13 12 13Z" stroke="#F1F5F9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                      <path d="M19 9.75C19 15.375 12 21 12 21C12 21 5 15.375 5 9.75C5 6.02208 8.13401 3 12 3C15.866 3 19 6.02208 19 9.75Z" stroke="#F1F5F9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                </svg>
                                                <h2 className='font-semibold lg:text-base text-sm text-slate-50 underline'>
                                                      {lang === 'ID' ? 'Bandara Privat Wiladatika' : 'Wiladatika Private Airport'}
                                                </h2>
                                          </div>
                                    </div>
                              </div>
                        </section>
                        <section className='lg:col-span-6 col-span-12 flex lg:flex-row flex-col items-start lg:gap-[100px] gap-[50px]'>
                              <form action={'#'} className='w-full flex flex-col'>
                                    ...
                                    <div className='w-full flex flex-col gap-y-[8px] mb-6'>
                                          ...
                                          <input
                                                ...
                                                id='email'
                                                className='form_input'
                                                placeholder={lang === 'ID' ? 'anda@perusahaan.com' : 'you@company.com'}
                                          />
                                    </div>
                                    ...
                                    <div className='w-full flex flex-col gap-y-[8px] mb-6'>
                                          ...
                                          <input
                                                ...
                                                id='subject'
                                                className='form_input'
                                                placeholder={lang === 'ID' ? 'Subjek' : 'Subject'}
                                          />
                                    </div>
                                    ...
                                    <div className='w-full flex flex-col gap-y-[8px] mb-[50px]'>
                                          ...
                                          <textarea
                                                ...
                                                id="message"
                                                className='form_input'
                                                placeholder={lang === 'ID' ? 'Tinggalkan pesan untuk kami...' : 'Leave us a message...'}
                                          ></textarea>
                                    </div>
