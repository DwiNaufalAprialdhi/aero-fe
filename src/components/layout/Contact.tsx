                              ...
                              <div className='w-full grid lg:grid-cols-2 grid-cols-1 lg:gap-[50px] gap-6'>
                                    <div className='w-full h-max flex flex-col gap-6'>
                                          <div className='w-full flex flex-col'>
                                                <h2 className='font-semibold lg:text-[24px] text-base text-slate-50'>Chat with us</h2>
                                          ...
                                          <div className='flex flex-col gap-y-[14px'>
                                                <div className='w-full flex items-center gap-x-[8px]'>
                                                      ...
                                                      <h2 className='font-semibold lg:text-base text-sm text-slate-50 underline'>Shoot us an email</h2>
                                                </div>
                                                <div className='w-full flex items-center gap-x-[8px]'>
                                                      ...
                                                      <h2 className='font-semibold lg:text-base text-sm text-slate-50 underline'>Message us on Instagram</h2>
                                                </div>
                                          </div>
                                    </div>
                                    <div className='w-full h-max flex flex-col gap-6'>
                                          <div className='w-full flex flex-col'>
                                                <h2 className='font-semibold lg:text-[24px] text-base text-slate-50'>Call us</h2>
                                    ...
                                    <div className='w-full h-max flex flex-col gap-6'>
                                          <div className='w-full flex flex-col'>
                                                <h2 className='font-semibold lg:text-[24px] text-base text-slate-50'>Visit us</h2>
                                          ...
                                          <div className='w-full flex items-center gap-x-[8px]'>
                                                ...
                                                <h2 className='font-semibold lg:text-base text-sm text-slate-50 underline'>Wiladatika Private Airport</h2>
                                          </div>
                                    </div>
                              </div>
                        </section>
