      ...
      return (
            <>
                  <div className='flex flex-col relative'>
                        <h2 className='absolute top-0 left-0 font-bold text-[128px] leading-none'>“</h2>
                        <h2 className='font-normal lg:text-[32px] text-[24px] lg:mb-[50px] mb-[24px] pt-[75px]'>{props.text}</h2>
