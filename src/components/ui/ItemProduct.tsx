...
export default function ItemProduct(props: ItemProductProps) {
      return (
            <>
                  <div className='lg:min-w-[356px] min-w-[306px] lg:min-h-[438px] min-h-[376px] overflow-hidden relative group'>
                        ...
                        <Image
                              ...
                              width={356}
                              height={438}
                              className='w-full h-full object-cover scale-110 duration-500'
                        />
